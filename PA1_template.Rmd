...
The mean total number of steps is `r format(mean_total_steps, digits=7, scientific=FALSE)`.  
The median total number of steps is  `r format(median_total_steps, digits=7, scientific=FALSE)`.
...
The 5-minute interval `r greatest_interval` on average contains the maximum number of steps.  
...
The total # of missing step values is `r total_number_of_missing_values`.  
the percent of missing step, date, and interval values from the activity dataset are `r percent_missing_activity_values` respectively.  
While the percent of missing step and interval from the 5 minute averages dataset are `r percent_missing_average_by_interval_values`.  
...
The mean total imputed number of steps is `r format(mean_total_imputed_steps, digits=7, scientific=FALSE)`.  
The median total imputed number of steps is  `r format(median_total_imputed_steps, digits=7, scientific=FALSE)`.  
